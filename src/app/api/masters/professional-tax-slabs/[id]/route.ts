...
import { professionalTaxSlabSchema } from '@/lib/validations/master';
...
export async function PUT(
  ...
  const existing = await prisma.professionalTaxSlab.findFirst({ where: { code: parsed.data.code, NOT: { id: parseInt(id) } } });
